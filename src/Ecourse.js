  ...
  return (
    <div className="ecourse-wrapper">
      ...
      <section>
        ...
        <div className="px-6">
          <img src={img2} alt="image2" className=" mb-4" />
        ...
        <div className="px-6">
          <img src={img3} alt="image3" className=" mb-4" />
...
Protect Water Quality</p>
        ...
        <div className="px-6">
          <img src={img4} alt="image4" className=" mb-4" />
        ...
        <div className="px-6">
          <img src={img5} alt="image5" className=" mb-4" />
          <div className="img5-text">
        ...
        <div className="px-6">
          <img src={img6} alt="image6" className=" mb-4" />
          <div className="img6-text">
